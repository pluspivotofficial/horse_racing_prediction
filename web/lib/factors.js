...
export const FACTOR_LABELS = {
  ...
  workout: "追い切り", pedigree: "血統", draw_fit: "枠順", condition: "馬体調子",
};
export const FACTOR_ORDER = [
  "recent_form", "class_fit", "workout", "distance_fit", "course_fit",
  "jockey_fit", "pace_fit", "pedigree", "going_fit", "weather_fit",
  "surface_fit", "condition", "draw_fit",
];
